<nav class="px-3 border-bottom  bg-white fixed-top">
                <div class="header-content ">
                    <nav class="navbar navbar-expand ">
                        ...
                        <div class="collapse d-flex navbar-collapse justify-content-between">
                                ...
                                <div class="nav-item d-flex align-items-center">
                                    <form action="">
                                        <div class="input-group search-area">
                                            ...
                                            <span class="input-group-text"><button type="submit" class="btn">
                                                    <i class='bx bx-search' style="margin-top: 6px;"></i>
                                                </button></span>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item dropdown header-profile">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href=" page-register" class="dropdown-item ai-icon">
